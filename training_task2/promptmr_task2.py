...
class SensitivityModel(nn.Module):
    ...
    def forward(self, masked_kspace: torch.Tensor, mask: torch.Tensor,
        ...
        computed_sens = self.compute_sens(self.norm_unet, images, self.low_mem)
    ...
    def _identify_mask_type(self, mask: torch.Tensor) -> str:
        center_lines = mask[..., mask.shape[3] // 2 - 8:mask.shape[3] // 2 + 8, 0] #mask[1,50,416,168,1]
    ...
    def _apply_radial_center_mask(self, masked_kspace: torch.Tensor, mask: torch.Tensor) -> torch.Tensor:
        ...
        masked_kspace[..., center_y - 8:center_y + 8, center_x - 8:center_x + 8, :] = masked_kspace[...,
